...
const EditPost = () => {
    ...
    const handleUpdate=async (e)=>{
      ...
      if(file){
        ...
        //img upload
        try{
          const imgUpload=await axios.post("https://your-backend.vercel.app"+"api/upload",data)
      ...
      try{
        const res=await axios.put("https://your-backend.vercel.app/api/posts/"+postId,post,{withCredentials:true})
